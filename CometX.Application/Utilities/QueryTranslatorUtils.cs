...
{
    public class QueryTranslateUtil : ExpressionVisitor
    {
        ...
        private bool ParseOrderByExpression(MethodCallExpression expression, string order)
        {
            ...
            lambdaExpression = (LambdaExpression)EvaluatorUtil.PartialEval(lambdaExpression);
